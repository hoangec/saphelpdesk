        ...
        <div class="content">
            <h2 class="header">
                ...
                <span class="pull-right">
                    ...
                    @endif
                    @if($u->isAdmin())
                      @if($ticket->status_id != $setting->grab('default_error_status_id'))
                         {!! link_to_route(
                            $setting->grab('main_route').'.error','Đánh dấu yêu cầu bị lỗi', $ticket->id,
                            [
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <p>
                                <strong>Ghi chú</strong>{{ trans('ticketit::lang.colon') }}
                                <span >
                                    {{ $ticket->subject}}
                                </span>
                            </p>
